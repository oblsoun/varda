...
<html lang="ko">
  <head>
    ...
    <title>Varda</title>
    <link rel="stylesheet" href="/resources/css/style_logout.css" />
  </head>
  <style>
  .image-container {
        ...
        <div class="menu-logout">
          <nav class="menuNav">
              <ul class="menu">
                  ...
                  <li><a href="../customer/login"><img src="/resources/img/mypage.png" alt="마이페이지" class="mypage"></a></li>
              </ul>
          </nav>
      </div>
      </header>
      ...
      <div id="contents">
        <div id="tabMenu">
          ...
          <div id="gallery" class="tabContent">
            <h2>신제품 소개</h2>
            <ul>
              <li><img src="/resources/img/img-1.jpg" /></li>
              <li><img src="/resources/img/img-2.jpg" /></li>
              <li><img src="/resources/img/img-3.jpg" /></li>
              <li><img src="/resources/img/img-1.jpg" /></li>
              <li><img src="/resources/img/img-2.jpg" /></li>
              <li><img src="/resources/img/img-3.jpg" /></li>
            </ul>
