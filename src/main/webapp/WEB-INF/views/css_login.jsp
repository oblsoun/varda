...
<body>
    <header>
        ...
        <div class="menu-logout">
          <nav class="menuNav">
              <ul class="menu">
                  ...
                  <li><a href="/Main/main_login.html"><img src="/img/logout.png" alt="로그아웃" class="logout"></a></li>  
              </ul>
          </nav>
      </div>
      </header>
      ...
      <div class="jb-wrap">
        <div class="jb-image"><img src="/img/banner.png" alt=""></div>
        <div class="jb-text">
    ...
    <div class="container">
        ...
        <div class="my-5">
            <div class="media" >
                <img src="/img/varda-5.png" class="mr-3">
