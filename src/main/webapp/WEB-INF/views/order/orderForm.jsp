...
<body>
    ...
    <div class="container" >
        ...
        <button type="submit" class="btn btn-outline-danger" id="order_button" onclick="orderCancel()">취소</button>
        <button type="submit" class="btn btn-outline-primary" id="order_button" onclick="orderSuccess()">제출</button>
        </form>
    </div> 
